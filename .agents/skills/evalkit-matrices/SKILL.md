...
Read `../evalkit/SKILL.md`, `../../../www/src/content/manual.md` (Configuration and discovery; Run from the CLI), `../../../packages/core/src/matrix.ts`, `../../../packages/cli/src/run-command.ts`, and `../../../packages/runner/src/matrix.ts`.
