...
export default defineConfig({
  ...
  integrations: [starlight({
    ...
    editLink: { baseUrl: 'https://github.com/leostera/evalkit/edit/main/www/' },
    customCss: ['./src/styles/starlight.css'],
    head: [
      { tag: 'link', attrs: { rel: 'alternate', type: 'text/plain', title: 'LLM guide', href: '/llms.txt' } },
      { tag: 'script', content: `try {
    ...
    sidebar: [
      ...
      { label: 'Manual', items: [
        ...
        { label: 'Project structure & discovery', link: '/docs/manual/project-structure/' },
        { label: 'Agents under test', link: '/docs/manual/agents/' },
        { label: 'Fixtures', link: '/docs/manual/fixtures/' },
        { label: 'Scorers & evals', link: '/docs/manual/scoring-and-evals/' },
